...
```bash
~/.claude/skills/feature-dev/scripts/check-spec-handoff.sh --ready docs/specs/<feature>.md
```
...
```bash
~/.claude/skills/feature-dev/scripts/check-spec-handoff.sh --complete docs/specs/<feature>.md
```
